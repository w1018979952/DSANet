...
def get_anchor_audio(flag):
    ...
    if flag == 0:
        with open('train_F2V_8vox1_label50.txt', 'r') as f:
            for line in f:
                str = line.split()
                FusionList_anchor_audio.append((str[0],) + (str[1],) + (str[2],) + (str[3],) + (str[4],) + (str[5],) + (str[6],)+ (str[7],) + (str[8],) + (str[9],))  
    elif flag == 1:
        with open('test_F2V_8vox1_label50.txt', 'r') as f:
            for line in f:
                str = line.split()
